    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"),
                    ...
                    Optional.of(new Notes("Likes photography")),
                    getTagSet("friends")),
            ...
            new Person(new Name("Charlotte Oliveiro"),
                    ...
                    Optional.of(new Notes("Allergic to peanuts")),
            ...
            new Person(new Name("David Li"),
                    ...
                    Optional.of(new Notes("Prefers email contact")),
                    getTagSet("family")),
            ...
            new Person(new Name("Roy Balakrishnan"),
                    ...
                    Optional.of(new Notes("Birthday gift idea: books")),
